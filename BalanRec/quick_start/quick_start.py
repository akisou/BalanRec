...
from BalanRec.model.general_recommender.ReRankExposure import ReRankExposure
from BalanRec.config import Config
from BalanRec.data import (
    create_dataset,
    data_preparation,
    save_split_dataloaders,
    load_split_dataloaders,
)
from BalanRec.data.transform import construct_transform
...
def run_recbole(
    ...
    # re_ranking
    rerank_model = ReRankExposure(config, train_data._dataset, test_data._dataset, [5, 10])
    rerank_model.reranking(logging, model)
