...
from BalanRec.utils.enum_type import ModelType
...
def get_model(model_name):
    ...
    if model_name == "balanrec":
        model_name = "BalanRecItemSide"
    ...
    for submodule in model_submodule:
        module_path = ".".join(["BalanRec.model", submodule, model_file_name])
...
def get_trainer(model_type, model_name):
    ...
    try:
        return getattr(
            importlib.import_module("BalanRec.trainer"), model_name + "Trainer"
        )
    except AttributeError:
        if model_type == ModelType.KNOWLEDGE:
            return getattr(importlib.import_module("BalanRec.trainer"), "KGTrainer")
        elif model_type == ModelType.TRADITIONAL:
            return getattr(
                importlib.import_module("BalanRec.trainer"), "TraditionalTrainer"
            )
        else:
            return getattr(importlib.import_module("BalanRec.trainer"), "Trainer")
