"""
data.dataloader.abstract_dataloader
################################################
"""
...
from BalanRec.utils import InputType, FeatureType, FeatureSource, ModelType
...
class AbstractDataLoader(torch.utils.data.DataLoader):
    ...
    :class:`~CoRec.data.interaction.Interaction` when it is iterated.
